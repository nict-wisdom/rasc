...
import jp.go.nict.wisdom.daemonizer.command.FutureAnalysisCommand;
import jp.go.nict.wisdom.daemonizer.command.StringIOCommand;

public class FutureAnalysisService extends AbstractTextAnalysisService {
	private static Logger logger = Logger.getLogger(FutureAnalysisService.class.getName());
	...
	public FutureAnalysisService() {
		logger.info("new FutureAnalysisService()");
	}

	@Override
	protected StringIOCommand getInstance() throws IOException, InterruptedException {
		return super.getInstance(FutureAnalysisCommand.class, cmdLine,
