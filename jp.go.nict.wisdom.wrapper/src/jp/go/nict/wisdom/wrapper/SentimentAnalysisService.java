...
import jp.go.nict.wisdom.daemonizer.command.SentimentAnalysisCommand;
import jp.go.nict.wisdom.daemonizer.command.StringIOCommand;

public class SentimentAnalysisService extends AbstractTextAnalysisService {
	private static Logger logger = Logger.getLogger(SentimentAnalysisService.class.getName());
	...
	public SentimentAnalysisService() {
		logger.info("new SentimentAnalysisService()");
	}

	@Override
	protected StringIOCommand getInstance() throws IOException, InterruptedException {
		return super.getInstance(SentimentAnalysisCommand.class, cmdLine,
