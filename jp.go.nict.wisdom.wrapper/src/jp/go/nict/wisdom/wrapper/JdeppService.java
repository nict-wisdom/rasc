...
import jp.go.nict.wisdom.daemonizer.command.JdeppCommand;
import jp.go.nict.wisdom.daemonizer.command.StringIOCommand;

public class JdeppService extends AbstractTextAnalysisService {
	private static Logger logger = Logger.getLogger(JdeppService.class.getName());
	...
	public JdeppService() {
		logger.info("new JdeppService()");
	}

	@Override
	protected StringIOCommand getInstance() throws IOException, InterruptedException {
		return super.getInstance(JdeppCommand.class, cmdLine,
