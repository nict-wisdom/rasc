 ...
 * @author mtanaka
 */
public class SentimentAnalysisCommand extends StringIOCommand{

	private static Logger logger = Logger.getLogger(SentimentAnalysisCommand.class.getName());
	...
	public SentimentAnalysisCommand(String[] cmd, String dir, String delimiterIn, String delimiterOut, boolean delLastNewline, boolean includeDelim, int timeOut, int startWait, int restartwait, int bufSize) {
